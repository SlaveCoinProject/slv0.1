...
#if defined(NDEBUG)
# error "Slavecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Slavecoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SLAVE additional fees, %d delta bytes\n",
