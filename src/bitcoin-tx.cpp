...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s slavecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  slavecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded slavecoin transaction") + "\n" +
              "  slavecoin-tx [options] -create [commands]   " + _("Create hex-encoded slavecoin transaction") + "\n" +
              "\n";
