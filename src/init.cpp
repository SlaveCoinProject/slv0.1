...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/slavecoin-project/slavecoin>";
    const std::string URL_WEBSITE = "<https://slavecoin.org>";
